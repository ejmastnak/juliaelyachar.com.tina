  ...
  return (
    <PageWrapper>
      ...
      <section className="mt-12">
        ...
        <h2 data-tina-field={tinaField(teachingPage, "coursesTaughtHeading")} className="text-4xl pb-3 border-b border-gray-200 w-fit">{teachingPage.coursesTaughtHeading}</h2>

        <p data-tina-field={tinaField(teachingPage, "syllabusAvailability")} className="italic my-6 text-gray-700">{teachingPage.syllabusAvailability}</p>
